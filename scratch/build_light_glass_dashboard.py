...
<head>
  ...
  <title>SHADOW TRADERS — F&O Liquid Glass Quant Terminal</title>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Cinzel:wght@800;900&family=Inter:wght@400;500;600;700;800&family=JetBrains+Mono:wght@500;600;700;800&family=Outfit:wght@500;600;700;800;900&family=Space+Grotesk:wght@600;700&display=swap" rel="stylesheet">
  
  <style>
    :root {{
      --glass-bg: rgba(255, 255, 255, 0.55);
      --glass-bg-core: rgba(255, 255, 255, 0.75);
      --glass-border: rgba(255, 255, 255, 0.8);
      --glass-border-subtle: rgba(255, 255, 255, 0.5);
      --glass-shadow: 0 8px 32px 0 rgba(31, 38, 135, 0.12), inset 0 1px 1px 0 rgba(255, 255, 255, 0.9);
    ...
    * {{ box-sizing: border-box; margin: 0; padding: 0; }}
    ...
    /* DISCLAIMER BANNER (CLEAN - NO ZERODHA LINE) */
    .disclaimer-banner {{
    ...
    .brand-text h1 {{
      ...
      background: linear-gradient(135deg, #0f172a 30%, var(--accent-blue) 75%, var(--accent-purple) 100%);
    ...
    .stat-card:hover {{
      ...
      box-shadow: 0 12px 40px rgba(31, 38, 135, 0.18), inset 0 1px 1px rgba(255, 255, 255, 1);
    }}
    ...
    .badge-buy-ce {{ background: rgba(5, 150, 105, 0.15); color: var(--accent-green); border: 1px solid var(--accent-green); }}
    .badge-buy-pe {{ background: rgba(220, 38, 38, 0.15); color: var(--accent-red); border: 1px solid var(--accent-red); }}
    .badge-scalp {{ background: rgba(2, 132, 199, 0.15); color: var(--accent-blue); border: 1px solid var(--accent-blue); }}
    .badge-fut {{ background: rgba(124, 77, 255, 0.15); color: var(--accent-purple); border: 1px solid var(--accent-purple); }}
...
"""
    ...
    print("Built Apple Liquid Glass Light Dashboard UI successfully!")

if __name__ == "__main__":
    build_light_glass_ui()
